...
import ProfileEditScreen from './src/screens/ProfileEditScreen'; // Sadece 1 kere import ettik
      ...
      <Stack.Navigator screenOptions={{ headerShown: false, animation: 'slide_from_right' }}>
        {!user ? (
          ...
          <>
            ...
            {/* BURAYA EKLENDİ: Admin profilini güncelleyebilsin */}
          ...
          <>
            ...
            {/* BURAYA EKLENDİ: Normal kullanıcı profilini güncelleyebilsin */}
            <Stack.Screen name="ProfileEdit" component={ProfileEditScreen} />
          </>
        )}
      </Stack.Navigator>
